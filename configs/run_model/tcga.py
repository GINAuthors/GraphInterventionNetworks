...
def add_params(parser):
    # -------------------------------------------------- Dataset --------------------------------------------------
    parser.add_argument('--dim_covariates', type=int, default=4000, help='Dimensions of covariates')
    parser.add_argument('--dim_node_features', type=int, default=78, help='Dimensions of node features')
    parser.add_argument('--num_treatments', type=int, default=10000, help='Number of available treatments')
    ...
    parser.add_argument('--gnn_conv', type=str, default="rcgn", choices=['gat', 'gcn', 'graph_conv', 'rcgn'])
    ...
    # ------------------------------------------------------ Propensity net --------------------------------------
    parser.add_argument('--num_propensity_layers', type=int, default=1,
