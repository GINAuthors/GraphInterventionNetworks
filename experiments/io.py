...
def load_train_dataset(args: Namespace):
    file_path = args.data_path + f'{args.task}/seed-{args.seed}/bias-{args.bias}/'
    dataset = pickle.load(open(file_path + 'in_sample.p', "rb"))
    return dataset


def load_test_dataset(args: Namespace):
    file_path = args.data_path + f'{args.task}/seed-{args.seed}/bias-{args.bias}/'
    dataset = pickle.load(open(file_path + 'test.p', "rb"))
    return dataset
...
def save_dataset(in_sample_dataset: Dataset, test_units: TestUnits,
                 args: Namespace):
    file_path = args.data_path + f'{args.task}/seed-{args.seed}/bias-{args.bias}/'
