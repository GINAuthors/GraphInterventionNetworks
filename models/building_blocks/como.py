...
class COMONet(NeuralNetworkEstimator):
    ...
    def __init__(self, args):
        ...
        self.mlp = MLP(dim_input=args.dim_covariates,
                       dim_hidden=args.dim_hidden_como,
                       dim_output=1,
                       num_layers=args.num_como_layers, batch_norm=args.mlp_batch_norm,
                       initialiser=args.initialiser, dropout=args.como_dropout, activation=args.activation,
